...
if( isset($link['title']) && $link['title'] != '' ) {
	$link_html = '<div> <a href="'.$link['url'].'" class="custom-link hvr-icon-wobble-horizontal" '.$add_parm .' style="color:'.$link_text_color.'!important;">'.$link['title'].' &nbsp;<i class="fa fa-arrow-right hvr-icon"></i></a> </div>';
} else {
	$link_html = '';
}
