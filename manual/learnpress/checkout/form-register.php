...
<div id="learn-press-checkout-register" class="learn-press-form register col-md-7 col-sm-12">
	...
	<div class="checkout-register-form-header">
		<h4><?php esc_html_e( 'New Customer', 'manual' ); ?></h4>

		<p><?php esc_html_e( 'Register Account', 'manual' ); ?></p>

		<p><?php esc_html_e( 'By creating an account you will be able to keep track of the course\'s progress you have previously enrolled.', 'manual' ); ?></p>
	</div>
