...
<form method="post" id="learn-press-profile-basic-information" name="profile-basic-information" enctype="multipart/form-data" class="learn-press-form">
	...
	<ul class="form-fields">
		...
		<li class="form-field form-field__first-name form-field__50">
			<label for="first_name"><?php esc_html_e( 'First name', 'manual' ); ?></label>
		...
		<li class="form-field form-field__last-name form-field__50">
			<label for="last_name"><?php esc_html_e( 'Last name', 'manual' ); ?></label>
			<div class="form-field-input">
				<input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $user->get_data( 'last_name' ) ); ?>" class="regular-text">
			</div>
		</li>
		<li class="form-field form-field__last-name form-field__50">
			<label for="account_display_name"><?php esc_html_e( 'Display name', 'manual' ); ?><span class="required">*</span></label>
			<div class="form-field-input">
		...
		<li class="form-field form-field__last-name form-field__50">
			<label for="account_email"><?php esc_html_e( 'Email address', 'manual' ); ?><span class="required">*</span></label>
			<div class="form-field-input">
		...
		<li class="form-field form-field__bio form-field__clear">
			<label for="description"><?php esc_html_e( 'Biographical Info', 'manual' ); ?></label>
			<div class="form-field-input">
				<textarea name="description" id="description" rows="5" cols="30"><?php esc_html_e( $user->get_data( 'description' ) ); ?></textarea>
				<p class="description"><?php esc_html_e( 'Share a little biographical information to fill out your profile. This may be shown publicly.', 'manual' ); ?></p>
			</div>
		</li>
	...
	<button type="submit" name="submit"><?php esc_html_e( 'Save changes', 'manual' ); ?></button>
