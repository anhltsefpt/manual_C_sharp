	...
	<div class="section-header">
		<div class="section-left">
			<h5>
				...
				echo ! $title ? _x( 'Untitled', 'template title empty', 'manual' ) : $title;
				?>
		...
		<?php if ( $user->has_enrolled_or_finished( $section->get_course_id() ) ) : ?>
			...
			<div class="section-meta">
				<div class="learn-press-progress" title="<?php echo esc_attr( sprintf( __( 'Section progress %s%%', 'manual' ), round( $percent, 2 ) ) ); ?>">
