...
extract(shortcode_atts(array(
	...
	'equal_height' => '',
	'normal_background_image_size' => 'cover',
), $atts));
...
if($row_type == 'row'){  
	if( $stretch_row_type == 'yes' && ( $video != 'show_video' ) ) { 
		...
		if( !empty($background_replace_color_by_image) ) { 
			...
			$replace_bk_image_css = "background: ".$background_color." url(".$replace_background_image[0].") ".$normal_background_image_position." / ".$normal_background_image_size." repeat;";
		} else {
