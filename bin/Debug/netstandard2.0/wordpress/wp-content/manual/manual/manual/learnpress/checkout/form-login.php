...
<div id="learn-press-checkout-login" class="learn-press-form login col-md-5 col-sm-12">
	...
	<div class="checkout-login-form-header">
		<h4><?php esc_html_e( 'Returning customer', 'manual' ) ?></h4>
		<p><?php esc_html_e( 'I am a returning customer.', 'manual' ) ?></p>
	</div>
	...
	<div id="checkout-form-login">
		<?php if ( 0 === 1 ) { ?>
			...
			<p>
				...
				<button id="learn-press-checkout-login-button"><?php esc_html_e( 'Login', 'manual' ); ?></button>
				<a href="" class="checkout-form-login-toggle"
				   data-toggle="hide"><?php esc_html_e( 'Cancel', 'manual' ); ?></a>
			</p>
		<?php } ?>
