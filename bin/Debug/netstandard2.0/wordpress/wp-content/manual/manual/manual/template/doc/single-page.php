		...
		if( isset($access_meta['login']) && $access_meta['login'] == 1 && !is_user_logged_in() ) {
			...
			*****************************************************/
			...
			if( $access_status == false ) {
				...
				**** TAGS ****
				*****************/
				if (is_single() && has_term( '', 'manual_doc_tag' )) {
			...
			**********************/
			...
			/***********************************************************************
			**** COMMENT STATUS - ACTIVATE ONLY IF DOC ARTICLE AJAX LOAD IF OFF ****
			************************************************************************/
			if( $theme_options['documentation-comment-status'] == true && $theme_options['documentation-disable-ajaxload-content'] == true ) {
