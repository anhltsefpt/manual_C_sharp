...
<script>
	jQuery(document).ready(function() { 
		...
		jQuery("a[rel='<?php echo sanitize_text_field($_COOKIE['manualDocSingleID']); ?>']").addClass('doc-active');
		jQuery("a[rel='<?php echo sanitize_text_field($_COOKIE['manualDocSingleID']); ?>']").parentsUntil('#list-manual', 'ul').slideDown(300).each(function(index, ele) {
